      ...
      <div className="container mx-auto flex justify-between">
        <nav className="flex">
          ...
          <NavLink
            to="/project"
            activeClassName="text-white bg-yellow-400"
            className="inline-flex items-center py-3 px-3 my-6 text-white rounded hover:text-green-800"
          >
            Projects
          </NavLink>
          <NavLink
        ...
        <div className="inline-flex py-3 px-3 my-6">
          <SocialIcon
            url="https://www.linkedin.com/in/stefanie-dz/"
            className="mr-4"
            target="_blank"
            fgColor="#fff"
          ...
          />
          <SocialIcon
            url="https://www.instagram.com/stefanie_dziadkowiec/"
            className="mr-4"
            target="_blank"
            fgColor="#fff"
            style={{ height: 35, width: 35 }}
